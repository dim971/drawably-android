...
internal data class Goldens(
    ...
    internal companion object {
        val shared: Goldens by lazy {
            val stream =
                checkNotNull(Goldens::class.java.getResourceAsStream("/goldens.json")) {
 ...
 */
internal val layerGenerators: Map<String, (Double, Double, RoughOptions) -> SketchPath> =
    mapOf(
